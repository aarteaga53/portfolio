        ...
        <div>
            <div className='footer'>
                <div className='profile-links'>
                    ...
                    <a className='profile-link' href='https://www.linkedin.com/in/andrew-arteaga-0b8065214/'><i className='fa fa-linkedin-square'></i></a>
                ...
                <p>&copy; {new Date().getFullYear()} Andrew Arteaga. All rights reserved.</p>
            </div>
        </div>
    )
}
